...
————————————————
入口：[组队分豆-安佳 (https://lzkjdz-isv.isvjcloud.com/pool/captain/12318?activityId=e7c37c2548284d1eb7920079fbf6be68&shareUuid=f59fc1a7eadd466a816d08b7e0fccf6e)]
...
!(async () => {
    ...
    for (let i = 0; i < cookiesArr.length; i++) {
        if (cookiesArr[i]) {
            ...
            authorCodeList = ['f59fc1a7eadd466a816d08b7e0fccf6e']
            $.bean = 0;
