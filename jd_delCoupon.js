...
const delRegex = [
  '仅可购买京东服务\\+',
  '^仅可购买(京东京造|个人护理|自营图书|服饰内衣|男装服饰|装备自营|内衣品类|国内机票|时尚居家美妆|自营格力空调|家具|京东药急送|内衣类目|康巴赫自营|厨具|德龙|三星平板|童装童鞋|男装|呼吸品类)部分商品$',
  '仅可购买(服饰内衣|茗茶|茶具|装修定制品类部分商品|京东国际居家指定|部分三只松鼠|部分良品铺子|部分家具|realme指定商品|呼吸品类部分自营|欧莱雅品牌部分自营)商品',
  '^限购 \\[.+\\] 店铺(部分)?商品$',
  '快递券',
  '.+快递.+寄件.+',
  '保障产品|宠物生活'
