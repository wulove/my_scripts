...
[task_local]
#炸年兽
6 0-23/5 * * * jd_zhanianshou.js, tag=炸年兽, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
...
let cookiesArr = [],
    ...
    message;
let secretp = '',
    inviteId = ['ZXASTT016aEzIlJOJLepV9qJVFjRWn6W7zB55awQ']
                    ...
                    for (var p = 0; p < res.taskVos.length; p++) {
                        ...
                        switch (task.taskType) {
                            ...
                            case 26:
                                ...
                                await $.wait(8000+ Math.floor(Math.random()*2500))
                                for (var o = 0; o < tmp.length; o++) {
                                    if (tmp[o].status == 1) {
                                        conti = true
