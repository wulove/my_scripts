...
async function main() {
  ...
  if ($.token) {
    ...
    await checkRisk();
    await getUserPkInfo();
    console.log(`当前胜局 ${$.pkInfo.winNum}，剩余主动挑战次数 ${$.pkInfo.leftLunchPkNum}，被挑战次数 ${$.pkInfo.leftAcceptPkNum}`)
    if ($.pkInfo.leftLunchPkNum === 0) {
      console.log('今日次数已耗尽')
      return;
    }
...
function checkRisk() {
  ...
  return new Promise((resolve) => {
    let options = {
      "url": `https://pengyougou.m.jd.com/like/jxz/checkRisk?actId=9&appId=${$.appId}&lkEPin=${$.pin}`,
      "headers": {
...
function getUserPkInfo() {
  console.log("获取用户京享值PK信息");
  return new Promise((resolve) => {
    let options = {
      "url": `https://pengyougou.m.jd.com/like/jxz/getUserPkInfo?actId=9&appId=${$.appId}&lkEPin=${$.pin}`,
      "headers": {
        "Referer": "https://game-cdn.moxigame.cn/ClickEliminate/IntegralPK_jd/thirdapp/index.html?&token=AAFgwYjmADD1CrUNjDlWrIKSUE5xguJH3wmor9ZeStzbDq5cXG2Me0PSQgXJvT5bAgJv_DErW1E&returnurl=https%3A%2F%2Fprodev.m.jd.com%2Fmall%2Factive%2F45njQg88Vym1s2EGp9aV6cPvqecw%2Findex.html%3Ftttparams%3DImfQnGideyJnTG5nIjoiMTE0LjM3OTc2NiIsImdMYXQiOiIzMC42MDE0NzEifQ8%253D%253D%26babelChannel%3Dttt1%26qdsource%3Dapp%26lng%3D114.362856%26lat%3D30.577543%26sid%3Dab2735c8cec04b1db8d32b4f406fef7w%26un_area%3D17_1381_50717_52133%23%2Findex&tttparams=ImfQnGideyJnTG5nIjoiMTE0LjM3OTc2NiIsImdMYXQiOiIzMC42MDE0NzEifQ8%3D%3D&babelChannel=ttt1&lng=114.362856&lat=30.577543&sid=ab2735c8cec04b1db8d32b4f406fef7w&un_area=17_1381_50717_52133&friendPin=109912ce317991bcdcca46aae737b4f2",
        "Host": "pengyougou.m.jd.com",
        "Content-Type": "application/json",
...
function getUserFriendsPage(pageNo = 1, pageSize = 10) {
  ...
  return new Promise(resolve => {
    let options = {
      "url": `https://pengyougou.m.jd.com/like/jxz/getUserFriendsPage?actId=9&appId=${$.appId}&lkEPin=${$.pin}&pageNo=${pageNo}&pageSize=${pageSize}`,
      "headers": {
        "Referer": "https://game-cdn.moxigame.cn/ClickEliminate/IntegralPK_jd/thirdapp/index.html?&token=AAFgwYjmADD1CrUNjDlWrIKSUE5xguJH3wmor9ZeStzbDq5cXG2Me0PSQgXJvT5bAgJv_DErW1E&returnurl=https%3A%2F%2Fprodev.m.jd.com%2Fmall%2Factive%2F45njQg88Vym1s2EGp9aV6cPvqecw%2Findex.html%3Ftttparams%3DImfQnGideyJnTG5nIjoiMTE0LjM3OTc2NiIsImdMYXQiOiIzMC42MDE0NzEifQ8%253D%253D%26babelChannel%3Dttt1%26qdsource%3Dapp%26lng%3D114.362856%26lat%3D30.577543%26sid%3Dab2735c8cec04b1db8d32b4f406fef7w%26un_area%3D17_1381_50717_52133%23%2Findex&tttparams=ImfQnGideyJnTG5nIjoiMTE0LjM3OTc2NiIsImdMYXQiOiIzMC42MDE0NzEifQ8%3D%3D&babelChannel=ttt1&lng=114.362856&lat=30.577543&sid=ab2735c8cec04b1db8d32b4f406fef7w&un_area=17_1381_50717_52133&friendPin=109912ce317991bcdcca46aae737b4f2",
        "Host": "pengyougou.m.jd.com",
        "Content-Type": "application/json",
...
function launchBattleNew(fpin) {
  ...
  return new Promise((resolve) => {
    ...
    let options = {
      "url": `https://pengyougou.m.jd.com/open/api/like/jxz/launchBattle?appId=${$.appId}&lkEPin=${$.pin}&lkToken=${$.lkToken}&sign=${sign}&t=${timestamp}`,
      "headers": {
        "Referer": "https://game-cdn.moxigame.cn/ClickEliminate/IntegralPK_jd/thirdapp/index.html?&token=AAFgwYjmADD1CrUNjDlWrIKSUE5xguJH3wmor9ZeStzbDq5cXG2Me0PSQgXJvT5bAgJv_DErW1E&returnurl=https%3A%2F%2Fprodev.m.jd.com%2Fmall%2Factive%2F45njQg88Vym1s2EGp9aV6cPvqecw%2Findex.html%3Ftttparams%3DImfQnGideyJnTG5nIjoiMTE0LjM3OTc2NiIsImdMYXQiOiIzMC42MDE0NzEifQ8%253D%253D%26babelChannel%3Dttt1%26qdsource%3Dapp%26lng%3D114.362856%26lat%3D30.577543%26sid%3Dab2735c8cec04b1db8d32b4f406fef7w%26un_area%3D17_1381_50717_52133%23%2Findex&tttparams=ImfQnGideyJnTG5nIjoiMTE0LjM3OTc2NiIsImdMYXQiOiIzMC42MDE0NzEifQ8%3D%3D&babelChannel=ttt1&lng=114.362856&lat=30.577543&sid=ab2735c8cec04b1db8d32b4f406fef7w&un_area=17_1381_50717_52133&friendPin=109912ce317991bcdcca46aae737b4f2",
        "Host": "pengyougou.m.jd.com",
        "Content-Type": "application/json",
...
function getScore(fpin) {
  ...
  return new Promise((resolve) => {
    let options = {
      "url": `https://pengyougou.m.jd.com/like/jxz/getScore?actId=9&appId=${$.appId}&lkEPin=${fpin}`,
      "headers": {
        "Referer": "https://game-cdn.moxigame.cn/ClickEliminate/IntegralPK_jd/thirdapp/index.html?&token=AAFgwYjmADD1CrUNjDlWrIKSUE5xguJH3wmor9ZeStzbDq5cXG2Me0PSQgXJvT5bAgJv_DErW1E&returnurl=https%3A%2F%2Fprodev.m.jd.com%2Fmall%2Factive%2F45njQg88Vym1s2EGp9aV6cPvqecw%2Findex.html%3Ftttparams%3DImfQnGideyJnTG5nIjoiMTE0LjM3OTc2NiIsImdMYXQiOiIzMC42MDE0NzEifQ8%253D%253D%26babelChannel%3Dttt1%26qdsource%3Dapp%26lng%3D114.362856%26lat%3D30.577543%26sid%3Dab2735c8cec04b1db8d32b4f406fef7w%26un_area%3D17_1381_50717_52133%23%2Findex&tttparams=ImfQnGideyJnTG5nIjoiMTE0LjM3OTc2NiIsImdMYXQiOiIzMC42MDE0NzEifQ8%3D%3D&babelChannel=ttt1&lng=114.362856&lat=30.577543&sid=ab2735c8cec04b1db8d32b4f406fef7w&un_area=17_1381_50717_52133&friendPin=109912ce317991bcdcca46aae737b4f2",
        "Host": "pengyougou.m.jd.com",
        "Content-Type": "application/json",
  ...
  return new Promise((resolve) => {
    let options = {
      ...
      "headers": {
        ...
        "Accept": "application/json, text/plain, */*",
        "User-Agent": $.isNode() ? (process.env.JD_USER_AGENT ? process.env.JD_USER_AGENT : (require('./USER_AGENTS').USER_AGENT)) : ($.getdata('JDUA') ? $.getdata('JDUA') : "jdapp;iPhone;9.2.2;14.2;%E4%BA%AC%E4%B8%9C/9.2.2 CFNetwork/1206 Darwin/20.1.0"),
        "Referer": "https://prodev.m.jd.com/mall/active/45njQg88Vym1s2EGp9aV6cPvqecw/index.html?tttparams=%3DQTniOYYeyJnTG5nIjoiMTIxLjQyOTcxOCIsImdMYXQiOiIyOC42NDc5ODkifQ8%3D%3D&babelChannel=ttt1&qdsource=app&lng=00.000000&lat=00.000000&sid=&un_area="
      }
    }
    $.post(options, (err, resp, res) => {
      try {
