...
[task_local]
#领金贴
10 0 * * * https://github.com/wulove/my_scripts/raw/master/jd_jin_tie.js, tag=领金贴, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
===========Loon===============
[Script]
cron "10 0 * * *" script-path=https://github.com/wulove/my_scripts/raw/master/jd_jin_tie.js,tag=领金贴
=======Surge===========
领金贴 = type=cron,cronexp="10 0 * * *",wake-system=1,timeout=3600,script-path=https://github.com/wulove/my_scripts/raw/master/jd_jin_tie.js
==============小火箭=============
领金贴 = type=cron,script-path=https://github.com/wulove/my_scripts/raw/master/jd_jin_tie.js, cronexpr="10 0 * * *", timeout=3600, enable=true
 */
const $ = new Env('领金贴');
...
function awardMission(missionId) {
  ...
  const options = taskUrl('awardCenterMission', body, 'jrm');
  return new Promise((resolve) => {
    $.get(options, (err, resp, data) => {
      try {
        if (err) {
