...
================Loon==============
[Script]
cron "24 1,12 * * *" script-path=https://raw.githubusercontent.com/msechen/script/main/jd_cjhz.js,tag=京东超级盒子
...
!(async () => {
    ...
    $.shareCoseList = [...new Set([...$.shareCoseList,'szgEaXOmVtssfEJORd8u8w','YEc69qHIi4_XW4rHNGtTzQ'])]
    //去助力与开箱
    for (let i = 0; i < cookiesArr.length; i++) {
        cookie = cookiesArr[i];
        if (cookie) {
