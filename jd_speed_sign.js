...
async function signInit() {
  return new Promise(resolve => {
    $.get(taskUrl('speedSignInit', {
      ...
      "kernelPlatform": "RN",
      "inviterId":"140oB9/DNfaRn46j3w7TR4On8bJjlhOf"
    }), async (err, resp, data) => {
      try {
        if (err) {
...
function invite2() {
  ...
  var headers = {
    ...
    'referer': 'https://assignment.jd.com/?inviterId=ZkwcpLegNlzAaWJFNT0DOIjvAArnAKULplIlLRGdC+0=&lng=0.000000&lat=0.000000&sid=2131b85f0bcb82714e032402628cc2fw&un_area=12_904_50647_57886',
    'Cookie': cookie
  };

  var dataString = `functionId=TaskInviteService&body={"method":"participateInviteTask","data":{"channel":"1","encryptionInviterPin":"ZkwcpLegNlzAaWJFNT0DOIjvAArnAKULplIlLRGdC%2B0%3D","type":1}}&appid=market-task-h5&uuid=&_t=${t}`;
