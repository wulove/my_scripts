/*
萌虎摇摇乐
cron 3 10,20 * * * https://raw.githubusercontent.com/star261/jd/main/scripts/jd_mhyyl.js
* */
const $ = new Env('萌虎摇摇乐');
const jdCookieNode = $.isNode() ? require('./jdCookie.js') : '';
let cookiesArr = [];
let allInvite = [{code:'d39f5cf2e20b48ea9c186e7c12f53f0f',user:'jd_rtrqrVNXHIXE',need:1},{code:'40df101114394d1a9210748ae372a79f',user:'恋你莲我',need:1}];
if ($.isNode()) {
